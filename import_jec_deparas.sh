...
bq load --location=us-east1 --project_id=tim-sdbx-qualidade-2a75 \
 ...
 --skip_leading_rows=1 --replace=true --source_format=CSV dm_prod.car_jec_dp_advogados \
...
bq load --location=us-east1 --project_id=tim-sdbx-qualidade-2a75 \
 --noautodetect --allow_quoted_newlines --field_delimiter="," \
 --skip_leading_rows=1 --replace=true --source_format=CSV dm_prod.car_jec_dp_condicao \
...
bq load --location=us-east1 --project_id=tim-sdbx-qualidade-2a75 \
 --noautodetect --allow_quoted_newlines --field_delimiter="," \
 --skip_leading_rows=1 --replace=true --source_format=CSV dm_prod.car_jec_dp_empresas \
...
bq load --location=us-east1 --project_id=tim-sdbx-qualidade-2a75 \
 --noautodetect --allow_quoted_newlines --field_delimiter="," \
 --skip_leading_rows=1 --replace=true --source_format=CSV dm_prod.car_jec_dp_escritorios \
...
bq load --location=us-east1 --project_id=tim-sdbx-qualidade-2a75 \
 --noautodetect --allow_quoted_newlines --field_delimiter="," \
 --skip_leading_rows=1 --replace=true --source_format=CSV dm_prod.car_jec_dp_juiz \
...
bq load --location=us-east1 --project_id=tim-sdbx-qualidade-2a75 \
 --noautodetect --allow_quoted_newlines --field_delimiter="," \
 --skip_leading_rows=1 --replace=true --source_format=CSV dm_prod.car_jec_dp_jurisdicao \
...
bq load --location=us-east1 --project_id=tim-sdbx-qualidade-2a75 \
 --noautodetect --allow_quoted_newlines --field_delimiter="," \
 --skip_leading_rows=1 --replace=true --source_format=CSV dm_prod.car_jec_dp_live_tim \
...
bq load --location=us-east1 --project_id=tim-sdbx-qualidade-2a75 \
 --noautodetect --allow_quoted_newlines --field_delimiter="," \
 --skip_leading_rows=1 --replace=true --source_format=CSV dm_prod.car_jec_dp_objetos \
...
bq load --location=us-east1 --project_id=tim-sdbx-qualidade-2a75 \
 --noautodetect --allow_quoted_newlines --field_delimiter="," \
 --skip_leading_rows=1 --replace=true --source_format=CSV dm_prod.car_jec_dp_orgao \
...
bq load --location=us-east1 --project_id=tim-sdbx-qualidade-2a75 \
 --noautodetect --allow_quoted_newlines --field_delimiter="," \
 --skip_leading_rows=1 --replace=true --source_format=CSV dm_prod.car_jec_dp_regional \
...
bq load --location=us-east1 --project_id=tim-sdbx-qualidade-2a75 \
 --noautodetect --allow_quoted_newlines --field_delimiter="," \
 --skip_leading_rows=1 --replace=true --source_format=CSV dm_prod.car_jec_dp_tipo_acao \
